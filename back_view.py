...
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   cv2.line(img,(points[0][0],height_y), points[0], (0, 255, 0), 3)
   cv2.imwrite("test.jpeg", img)
  #  print(height_x, height_y)
  #  print(points[0])
   # visualized_mask = visualized_mask.astype(int)
   # print(visualized_mask)

   for i in range(height_y-1, points[0][1]):
      data = [int(visualized_mask[i][points[0][0]][0]), int(visualized_mask[i][points[0][0]][1]), int(visualized_mask[i][points[0][0]][2])]
  ...
  #  print("end_pixel_final :", end_pixel_final)
   ...
   img = cv2.imread(file_name)
   cv2.line(img,(points[0][0], start_pixel_final), (points[0][0], int(end_pixel_final)), (0, 255, 0), 3)
   ...
   chest = chest_p + int((waist_p - chest_p)*0.35)
   ...
   cv2.imwrite("back_test_1.jpeg", img)
   ...
   cv2.imwrite("back_test_2.jpeg", visualized_mask)
   
   chest_length = (end_pixel_chest - start_pixel_chest)
   waist_length = (end_pixel_waist - start_pixel_waist)


   print("chest_length(b) :",chest_length*ppm)
   print("waist_length(b) :", waist_length*ppm)

   return (chest_length*ppm, waist_length*ppm)

# measurement("75.jpeg", 5.1)